...
void toggleSleepMode(WINDOW *win_jtop, int STACK_WIN_MAX_COL){
    if(sleepMode){
        ...
        mvwprintw(win_jtop, 1, 7, "STATE  ");
        mvwprintw(win_jtop, 1, 15, "PCPU  ");
        mvwprintw(win_jtop, 1, 22, "CCPU  ");
        mvwprintw(win_jtop, 1, 29, "MinFault  ");
        mvwprintw(win_jtop, 1, 40, "MajFault  ");
        mvwprintw(win_jtop, 1, 51, "SECS  ");
        mvwprintw(win_jtop, 1, 59, "SEGV ");
        mvwprintw(win_jtop, 1, 64, "BLK  ");
        mvwprintw(win_jtop, 1, 69, "Name                 ");
        mvwprintw(win_jtop, 1, 91, "Command  ");
...
int main(int argc, char **argv) {
    ...
    mvwprintw(win_jtop, 1, 60, "SEGV ");
    mvwprintw(win_jtop, 1, 65, "BLK  ");
    mvwprintw(win_jtop, 1, 70, "Name                 ");
    mvwprintw(win_jtop, 1, 97, "Command  ");
    //mvwchgat(win_jtop,"test1001");
    wattroff(win_jtop, A_BOLD);
    wattroff(win_jtop, COLOR_PAIR(6));
    use_default_colors();
